...
-- Insert the new integrated speaking practice test about extended gym hours (with proper UUIDs)
...
-- Insert the corresponding question for the gym hours test (with proper UUIDs)
