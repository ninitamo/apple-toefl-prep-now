...
-- Insert Test 21 into the toefl_tests table
INSERT INTO public.toefl_tests (
  ...
  'TOEFL iBT Practice Test 21',
  'Expert',
  '3.5 hours',
  'An expert-level TOEFL practice test exploring Mendelian genetics in biology and comparative advantage in international trade economics.',
  '620'
);
...
('00000000-0000-0000-0000-000000002101', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 1, 'Factual Information', 'According to paragraph 1, what method did Mendel use in his experiments?', '["He studied wild plants in natural environments.", "He used chemical treatments to alter DNA.", "He selectively bred pea plants and recorded trait patterns.", "He consulted other scientists in his monastery."]', '2'),
('00000000-0000-0000-0000-000000002102', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 2, 'Vocabulary', 'The word "discrete" in paragraph 2 is closest in meaning to:', '["complex", "visible", "separate", "unknown"]', '2'),
('00000000-0000-0000-0000-000000002103', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 3, 'Inference', 'What can be inferred about the presence of recessive traits in the F1 generation?', '["They were eliminated through breeding.", "They were expressed alongside dominant traits.", "They were hidden and reappeared in later generations.", "They never existed in the gene pool."]', '2'),
('00000000-0000-0000-0000-000000002104', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 4, 'Sentence Simplification', 'Which best expresses this sentence from paragraph 4: "By then, advances in microscopy and cell biology had revealed chromosomes, allowing researchers to connect Mendel''s abstract ''factors'' to physical structures within cells."', '["Scientists used new microscopes to confirm Mendel''s results.", "Researchers discovered that genes exist inside cells on chromosomes.", "Chromosomes proved Mendel was wrong about inheritance.", "Biology became more abstract after Mendel''s time."]', '1'),
('00000000-0000-0000-0000-000000002105', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 5, 'Negative Factual Information', 'According to the passage, all of the following are examples of non-Mendelian inheritance EXCEPT:', '["Codominance", "Polygenic traits", "Incomplete dominance", "Homozygous dominance"]', '3'),
('00000000-0000-0000-0000-000000002106', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 6, 'Factual Information', 'What happened to Mendel''s work during his lifetime?', '["It was instantly accepted by the scientific community.", "It was widely misunderstood and applied incorrectly.", "It was overlooked and rediscovered much later.", "It was published anonymously."]', '2'),
('00000000-0000-0000-0000-000000002107', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 7, 'Insert Text', 'Insert this sentence into paragraph 4: "This discovery transformed Mendel''s theoretical framework into a concrete biological model." Where would this best fit?', '["At the beginning of the paragraph", "After the sentence about rediscovering papers", "After the sentence about connecting factors to chromosomes", "At the end of the paragraph"]', '2'),
('00000000-0000-0000-0000-000000002108', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 8, 'Vocabulary', 'The word "enrich" in paragraph 6 is closest in meaning to:', '["challenge", "complicate", "confirm", "enhance"]', '3'),
('00000000-0000-0000-0000-000000002109', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 9, 'Inference', 'Why is Mendelian genetics still relevant today, according to paragraph 7?', '["It is a foundational concept that applies across multiple fields.", "It has replaced all other models of inheritance.", "It explains how all genetic disorders arise.", "It focuses primarily on human biology."]', '0'),
('00000000-0000-0000-0000-000000002110', '00000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000123', 'reading', 10, 'Prose Summary', 'Gregor Mendel''s experiments laid the foundation for modern genetics by explaining how traits are inherited. Select THREE answer choices that express the most important ideas in the passage.', '["He discovered that dominant and recessive traits are passed in predictable ratios.", "His ideas were forgotten but later revived when connected to chromosome research.", "Non-Mendelian inheritance patterns prove that his work was incorrect.", "His theories now assist fields like agriculture and medicine.", "All traits in biology strictly follow Mendelian patterns.", "Modern genetics has expanded upon Mendel''s model to include more complex inheritance."]', '[0, 1, 5]');
