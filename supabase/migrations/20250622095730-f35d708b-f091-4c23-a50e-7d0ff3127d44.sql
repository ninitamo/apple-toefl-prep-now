...
-- Insert Test 7 into the toefl_tests table
INSERT INTO public.toefl_tests (
  ...
  'TOEFL iBT Practice Test 7',
  'Advanced',
  '3 hours',
  'A comprehensive TOEFL practice test featuring sociology and art history reading passages with authentic question types.',
  '1,420'
);
...
('00000000-0000-0000-0000-000000000701', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 1, 'Factual Information', 'According to paragraph 2, which group is most influential in persuading others to adopt innovations?', '["Innovators", "Early adopters", "Late majority", "Laggards"]', '1'),
('00000000-0000-0000-0000-000000000702', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 2, 'Vocabulary', 'The word "skeptical" in paragraph 2 is closest in meaning to:', '["Curious", "Confident", "Doubtful", "Inexperienced"]', '2'),
('00000000-0000-0000-0000-000000000703', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 3, 'Inference', 'What can be inferred about innovations with high complexity?', '["They are more likely to be adopted by innovators.", "They spread more rapidly than other types.", "They are usually mandated by governments.", "They may face slower adoption rates."]', '3'),
('00000000-0000-0000-0000-000000000704', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 4, 'Sentence Simplification', 'Which best expresses this sentence from paragraph 3: "Another is compatibility, or how consistent the innovation is with existing values and practices."', '["Compatibility shows whether people like something new.", "If an innovation aligns with current beliefs, it is more likely to be accepted.", "People only adopt innovations that completely replace their habits.", "Compatibility depends on how new an innovation is."]', '1'),
('00000000-0000-0000-0000-000000000705', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 5, 'Negative Factual Information', 'According to the passage, all of the following affect the rate of diffusion EXCEPT:', '["The ability to try the innovation before adopting it", "How quickly people can return the innovation", "The simplicity of the innovation", "How well the innovation fits cultural values"]', '1'),
('00000000-0000-0000-0000-000000000706', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 6, 'Factual Information', 'What does paragraph 4 say about the influence of mass media in the diffusion process?', '["It often leads directly to adoption.", "It has more influence than personal interactions.", "It primarily raises awareness of innovations.", "It is only effective for highly technical products."]', '2'),
('00000000-0000-0000-0000-000000000707', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 7, 'Insert Text', 'Insert this sentence: "These adopter groups form a bell curve when plotted across time, reflecting how innovations gradually become mainstream." Where would it best fit in paragraph 2?', '["At the beginning of the paragraph", "After the sentence about early adopters", "After the sentence about laggards", "At the end of the paragraph"]', '2'),
('00000000-0000-0000-0000-000000000708', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 8, 'Vocabulary', 'The word "mandated" in paragraph 5 is closest in meaning to:', '["Suggested", "Officially required", "Silently introduced", "Personally endorsed"]', '1'),
('00000000-0000-0000-0000-000000000709', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 9, 'Inference', 'Why does the author mention electric cars in paragraph 6?', '["To show how infrastructure can spread innovation", "To illustrate how failed innovations can later succeed", "To criticize early technology companies", "To explain how media supports new products"]', '1'),
('00000000-0000-0000-0000-000000000710', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000071', 'reading', 10, 'Prose Summary', 'The diffusion of innovations explains how new behaviors and technologies spread through populations. Select THREE answer choices that express the most important ideas in the passage.', '["People adopt innovations at different rates based on social and psychological factors.", "Communication networks and cultural compatibility affect the success of diffusion.", "Mass media is usually more persuasive than personal contacts.", "Diffusion patterns vary across hierarchical and community-based systems.", "Innovations that are difficult to use tend to be adopted more quickly.", "External conditions like timing and infrastructure can influence success."]', '[0, 1, 5]');
...
('00000000-0000-0000-0000-000000000711', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 11, 'Factual Information', 'According to paragraph 1, what was the original reaction to the name "Impressionism"?', '["It was embraced by the artists themselves.", "It was coined by Monet as a title.", "It was intended as criticism.", "It described their attention to detail."]', '2'),
('00000000-0000-0000-0000-000000000712', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 12, 'Vocabulary', 'The word "marginalization" in paragraph 2 is closest in meaning to:', '["Elimination", "Acceptance", "Rejection", "Specialization"]', '2'),
('00000000-0000-0000-0000-000000000713', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 13, 'Inference', 'What can be inferred about painting en plein air?', '["It was only practiced by rural painters.", "It allowed artists to mimic historical painting styles.", "It contributed to more realistic depictions of light and color.", "It limited the subjects painters could choose."]', '2'),
('00000000-0000-0000-0000-000000000714', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 14, 'Sentence Simplification', 'Which of the following best expresses this sentence from paragraph 3: "Rather than carefully blending pigments to match a subject exactly, Impressionists placed dabs of color side by side, relying on the viewer''s eye to mix them at a distance."', '["Impressionists used color to highlight their favorite subjects.", "The use of bright colors was inspired by ancient art.", "They painted without mixing pigments, trusting the viewer''s perception.", "Blending pigments was essential to the success of their style."]', '2'),
('00000000-0000-0000-0000-000000000715', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 15, 'Negative Factual Information', 'According to the passage, which of the following was NOT a subject commonly painted by Impressionists?', '["Mythological figures", "Urban environments", "Landscapes", "Social scenes"]', '0'),
('00000000-0000-0000-0000-000000000716', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 16, 'Factual Information', 'What advantage did portable paint tubes provide to the Impressionists?', '["They lowered the cost of paint significantly.", "They allowed artists to blend colors more easily.", "They enabled artists to work outside studios.", "They helped replicate historical painting styles."]', '2'),
('00000000-0000-0000-0000-000000000717', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 17, 'Insert Text', 'Insert this sentence: "This decision allowed them greater freedom in exhibiting works that challenged academic standards." Where would it best fit in paragraph 4?', '["At the beginning of the paragraph", "After the sentence about organizing independent exhibitions", "After the sentence about initial criticism", "At the end of the paragraph"]', '1'),
('00000000-0000-0000-0000-000000000718', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 18, 'Vocabulary', 'The phrase "aesthetic innovation" in paragraph 5 is closest in meaning to:', '["Artistic creativity", "Business efficiency", "Cultural preservation", "Religious devotion"]', '0'),
('00000000-0000-0000-0000-000000000719', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 19, 'Inference', 'Why does the author mention photography in paragraph 5?', '["To show how it made painting more difficult", "To argue that photography replaced painting", "To explain a factor that encouraged more abstract art", "To describe how Impressionists used cameras"]', '2'),
('00000000-0000-0000-0000-000000000720', '00000000-0000-0000-0000-000000000007', '00000000-0000-0000-0000-000000000072', 'reading', 20, 'Prose Summary', 'Impressionism was a groundbreaking art movement that redefined how artists approached light, color, and subject matter. Select THREE answer choices that express the most important ideas in the passage.', '["It emerged in reaction to rigid academic traditions that limited artistic expression.", "Impressionist techniques often relied on scientific theories about vision and perception.", "Most Impressionists painted religious themes to appeal to a broad audience.", "The movement gained acceptance gradually through independent exhibitions.", "Impressionists were largely isolated from changes in technology and society.", "New materials and technologies helped Impressionists work in novel ways."]', '[0, 1, 3]');
