...
-- Insert the new integrated speaking practice test about extended gym hours (with conflict handling)
...
-- Insert the corresponding question for the gym hours test (with conflict handling)
