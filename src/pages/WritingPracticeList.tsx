...
const WritingPracticeList = () => {
  ...
  const [selectedPracticeType, setSelectedPracticeType] = useState<'grammar' | 'quiz' | null>(null);
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-4xl mx-auto">
            {!selectedPracticeType ? (
              <>
                <h2 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4 text-center">Writing Practice</h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
                  ...
                  <Card 
                    ...
                    onClick={() => setSelectedPracticeType('grammar')}
                  >
                    <CardContent className="p-8 text-center">
                      <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-6">
                        <BookOpen className="h-10 w-10 text-white" />
                      </div>
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Grammar Practice</h3>
                      <p className="text-gray-600 dark:text-gray-400 mb-6">
                        Master TOEFL grammar with comprehensive quizzes and writing exercises
                      </p>
                      <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        <div className="flex justify-between">
                          <span>Grammar Quizzes:</span>
                          <span className="font-semibold">{quizSets.length} sets</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Writing Exercises:</span>
                          <span className="font-semibold">{practiceExercises.length} tasks</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  >
                    <CardContent className="p-8 text-center">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">Quiz Practice</h3>
                      <p className="text-gray-600 dark:text-gray-400 mb-6">
                        Practice mixed skills including rephrasing, error correction, and essay building
                      </p>
                      <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                        <div className="flex justify-between">
                          <span>Mixed Practice Sets:</span>
                          <span className="font-semibold">{mixedPracticeQuizzes.length} sets</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Skill Areas:</span>
                          <span className="font-semibold">5+ skills</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
