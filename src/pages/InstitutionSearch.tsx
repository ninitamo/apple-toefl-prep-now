            ...
            <div className="text-center mb-8">
              ...
              <div>
                <div className="mt-4 flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <span>This site uses AI-powered search.
                  </span>
                </div>
                <span className="text-xs text-gray-600 dark:text-gray-400">
                  The information provided by this tool is generated by artificial intelligence and web search. It may not be accurate, complete, or up to date. Always verify details directly with the official university website or admissions office before making decisions.
                </span>
              </div>
