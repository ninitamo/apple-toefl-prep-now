...
const TeamSection = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      role: 'Assessment Technology Director',
      description: 'Educational technology expert specializing in adaptive learning systems and digital assessment platforms.',
      image: '/placeholder.svg',
      links: {
        linkedin: '#',
        email: 'elena@toeflprep.com',
        website: '#'
      }
    },
    {
      ...
      description: 'Linguistic researcher and former university professor ensuring content accuracy and pedagogical effectiveness.',
      image: '/placeholder.svg',
      links: {
        linkedin: '#',
        email: 'james@toeflprep.com',
        website: '#'
      }
    }
  ];
